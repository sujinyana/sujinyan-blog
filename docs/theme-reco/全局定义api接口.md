---
title: 全局定义api接口
date: 2019-07-25 22:25:08
tags: [api]
---



## 设置全局的 api接口 防止在修改 url之后 改动大量代码
...
# [vue-cli脚手架config目录下index.js配置文件详解](https://www.cnblogs.com/ye-hcj/p/7077796.html)
